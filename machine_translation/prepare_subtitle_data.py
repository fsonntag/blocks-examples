...
parser.add_argument("-t", "--target", type=str, help="Target language",
                    default="en")
parser.add_argument("--source-dev", type=str, default="newstest2013.de",
...
def create_vocabularies(tr_files, preprocess_file):
    src_vocab_name = os.path.join(
        OUTPUT_DIR, 'vocab.{}-{}.{}.os.pkl'.format(
...
def main():
    ...
    valid_data_file = os.path.join(OUTPUT_DIR, 'tmp', 'valid_data.os.tgz')
